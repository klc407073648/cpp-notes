// C++ page
export function genSidebar4Cplusplus() {
    return [
        {
            title: "C++ 基础",
            collapsable: false,
...
// Database page
export function genSidebar4Database() {
    return [
        {
            title: "SQL - MySQL",
            collapsable: false,
...
// Alg page
export function genSidebar4Alg() {
    return [
        {
            title: "领域算法",
            collapsable: false,
...
// Program page
export function genSidebar4Program() {
    return [
        {
            title: "数据结构基础",
            collapsable: false,
...
// develop page
export function genSidebar4develop() {
    return [
        {
            title: "开发",
            collapsable: false,
...
// micro-services page
export function genSidebar4microServices() {
    return [
        {
            title: "理论基础",
            collapsable: false,
...
// arch page
export function genSidebar4arch() {
    return [
        {
            title: "理论基础",
            collapsable: false,
...
// method page
export function genSidebar4method() {
    return [
        {
            title: "概念",
            collapsable: false,
...
// Devops page
export function genSidebar4Devops() {
    return [
        {
            title: "Linux",
            collapsable: false,
...
// project page
export function genSidebar4project() {
    return [
        {
            title: "实践 - Docker",
            collapsable: false,
...
// book-note page
export function genSidebar4booknote() {
    return [
        {
            title: "书籍推荐",
            collapsable: false,
...
// interview page
export function genSidebar4interview() {
    return [
        {
            title: "八股文",
            collapsable: false,
...
// article page
export function genSidebar4Article() {
    return [
        {
            title: "分布式相关",
            collapsable: false,
...
// daily-use page
export function genSidebar4dailyUse() {
    return [
        {
            title: "在线技术文档",
            collapsable: false,
...
// About page
export function genSidebar4About() {
    return [
        {
            title: "关于",
            collapsable: false,
