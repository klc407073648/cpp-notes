...
![1630768869208](/_images/project/study/maven/按模块拆分.png)
...
![](/_images/project/study/maven/依赖传递.png)
...
![](/_images/project/study/maven/Dependencies面板.png)

如果想更全面的查看Maven中各个坐标的依赖关系，可以点击Maven面板中的`show Dependencies`

![](/_images/project/study/maven/show_Dependencies.png)
...
![](/_images/project/study/maven/依赖传递关系.png)
...
![](/_images/project/study/maven/聚合.png)
...
![](/_images/project/study/maven/使用聚合统一管理项目.png)
...
![](/_images/project/study/maven/重复配置问题.png)
...
![](/_images/project/study/maven/引入不需要的jar.png)
...
![](/_images/project/study/maven/配置文件加载属性是否生效.png)
...
![](/_images/project/study/maven/Maven中的属性.png)

## 版本管理

在Maven创建项目和引用别人项目的时候，看到过如下内容:

![](/_images/project/study/maven/版本管理中版本号.png)

这里面有两个单词，SNAPSHOT和RELEASE，它们所代表的含义是什么呢?

打开Maven仓库地址`https://mvnrepository.com/`

![](/_images/project/study/maven/版本管理版本号示例.png)
...
![](/_images/project/study/maven/多环境开发.png)
...
![](/_images/project/study/maven/IDEA工具实现跳过测试.png)
...
![](/_images/project/study/maven/团队开发现状.png)
...
![](/_images/project/study/maven/私服界面.png)
...
![](/_images/project/study/maven/私服资源操作流程.png)
...
![](/_images/project/study/maven/私服仓库分类.png)

## 本地仓库访问私服配置

![](/_images/project/study/maven/本地仓库访问私服配置.png)

需要在本地Maven的配置文件`settings.xml`中进行配置。

1. 步骤1:私服上配置仓库

![](/_images/project/study/maven/私服上配置仓库.png)
...
![](/_images/project/study/maven/配置私服的访问路径.png)
...
![](/_images/project/study/maven/私服发布成功.png)

现在发布是在itheima-snapshot仓库中，如果想发布到itheima-release仓库中就需要将项目pom.xml中的version修改成RELEASE即可。

如果想删除已经上传的资源，可以在界面上进行删除操作:

![](/_images/project/study/maven/私服进行删除.png)

如果私服中没有对应的jar，会去中央仓库下载，速度很慢。可以配置让私服去阿里云中下载依赖。

![](/_images/project/study/maven/私服去阿里云中下载依赖.png)
