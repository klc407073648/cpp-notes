...
![SQL解析原理](/_images/database/mysql/SQL解析原理.png)
...
![语法树](/_images/database/mysql/语法树.png)
...
![无用条件去除a](/_images/database/mysql/无用条件去除a.png)

![无用条件去除b](/_images/database/mysql/无用条件去除b.png)

![无用条件去除c](/_images/database/mysql/无用条件去除c.png)

![无用条件去除d](/_images/database/mysql/无用条件去除d.png)
